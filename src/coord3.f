...
C***********************************************************************
C
      SUBROUTINE COORD3 (XB,YB,XX,YY,S,T,INODE,ICONV)
C
C     ******************************************************************
C
C     SUBROUTINE TO LOCATE NORMALIZED COORDINATES S,T IN PARENT ELEMENT
C     SUBPARAMETRIC SIX-NODE TRIANGLE
C
C     ******************************************************************
C
      DIMENSION XX(*), YY(*)
...
C
      FX(SP,TP)=XX(1)*SP+XX(2)*TP+XX(3)*(1.-SP-TP)
C
      FY(SP,TP)=YY(1)*SP+YY(2)*TP+YY(3)*(1.-SP-TP)
C
      DFXDS(SP,TP)=XX(1)-XX(3)
C
      DFYDS(SP,TP)=YY(1)-YY(3)
C
      DFXDT(SP,TP)=XX(2)-XX(3)
C
      DFYDT(SP,TP)=YY(2)-YY(3)
C
C     ******************************************************************
C
