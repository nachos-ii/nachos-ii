...
C***********************************************************************
C
      SUBROUTINE SHAPE8 (NGAUSS,GS1,GS2)
C
C     ******************************************************************
C
...
C
      ...
      DO 10 K=1,NGAUSS
      DO 10 J=1,NGAUSS
      DF8QDS(I,L)=DFCDS(I,GS1(J),GS2(K))
      DF8QDT(I,L)=DFCDT(I,GS1(J),GS2(K))
      F8Q(I,L)=FC(I,GS1(J),GS2(K))
      F8L(I,L)=G(I,GS1(J),GS2(K))
      L=L+1
   10 CONTINUE
      DO 20 I=5,8
      L=1
      DO 20 K=1,NGAUSS
      DO 20 J=1,NGAUSS
      DF8QDS(I,L)=DFMDS(I,GS1(J),GS2(K))
      DF8QDT(I,L)=DFMDT(I,GS1(J),GS2(K))
      F8Q(I,L)=FM(I,GS1(J),GS2(K))
      L=L+1
   20 CONTINUE
C
      RETURN
